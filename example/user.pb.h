...
// .fixbug.ResultCode result = 1;
inline bool RegResponse::_internal_has_result() const {
  return this != internal_default_instance() && _impl_.result_ != nullptr;
}
inline bool RegResponse::has_result() const {
  return _internal_has_result();
}
inline void RegResponse::clear_result() {
  if (GetArenaForAllocation() == nullptr && _impl_.result_ != nullptr) {
    delete _impl_.result_;
  }
  _impl_.result_ = nullptr;
}
inline const ::fixbug::ResultCode& RegResponse::_internal_result() const {
  const ::fixbug::ResultCode* p = _impl_.result_;
  return p != nullptr ? *p : reinterpret_cast<const ::fixbug::ResultCode&>(
      ::fixbug::_ResultCode_default_instance_);
}
inline const ::fixbug::ResultCode& RegResponse::result() const {
  // @@protoc_insertion_point(field_get:fixbug.RegResponse.result)
  return _internal_result();
}
inline void RegResponse::unsafe_arena_set_allocated_result(
    ::fixbug::ResultCode* result) {
  if (GetArenaForAllocation() == nullptr) {
    delete reinterpret_cast<::PROTOBUF_NAMESPACE_ID::MessageLite*>(_impl_.result_);
  }
  ...
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:fixbug.RegResponse.result)
}
inline ::fixbug::ResultCode* RegResponse::release_result() {
...
inline ::fixbug::ResultCode* RegResponse::unsafe_arena_release_result() {
  // @@protoc_insertion_point(field_release:fixbug.RegResponse.result)
  
  ::fixbug::ResultCode* temp = _impl_.result_;
  _impl_.result_ = nullptr;
  return temp;
}
inline ::fixbug::ResultCode* RegResponse::_internal_mutable_result() {
...
inline ::fixbug::ResultCode* RegResponse::mutable_result() {
  ::fixbug::ResultCode* _msg = _internal_mutable_result();
  // @@protoc_insertion_point(field_mutable:fixbug.RegResponse.result)
  return _msg;
}
inline void RegResponse::set_allocated_result(::fixbug::ResultCode* result) {
  ::PROTOBUF_NAMESPACE_ID::Arena* message_arena = GetArenaForAllocation();
  if (message_arena == nullptr) {
    delete _impl_.result_;
  }
  ...
  _impl_.result_ = result;
  // @@protoc_insertion_point(field_set_allocated:fixbug.RegResponse.result)
}

// uint32 id = 2;
inline void RegResponse::clear_id() {
  _impl_.id_ = 0u;
}
inline uint32_t RegResponse::_internal_id() const {
  return _impl_.id_;
}
inline uint32_t RegResponse::id() const {
  // @@protoc_insertion_point(field_get:fixbug.RegResponse.id)
  return _internal_id();
}
inline void RegResponse::_internal_set_id(uint32_t value) {
  
  _impl_.id_ = value;
}
inline void RegResponse::set_id(uint32_t value) {
  _internal_set_id(value);
  // @@protoc_insertion_point(field_set:fixbug.RegResponse.id)
}
