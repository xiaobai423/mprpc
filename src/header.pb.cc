...
PROTOBUF_CONSTEXPR RpcHeader::RpcHeader(
  ...
  , /*decltype(_impl_.service_method_)*/{&::_pbi::fixed_address_empty_string, ::_pbi::ConstantInitialized{}}
...
const uint32_t TableStruct_header_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  PROTOBUF_FIELD_OFFSET(::mprpc::RpcHeader, _impl_.service_method_),
  PROTOBUF_FIELD_OFFSET(::mprpc::RpcHeader, _impl_.arg_size_),
};
...
const char descriptor_table_protodef_header_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  "\n\014header.proto\022\005mprpc\"K\n\tRpcHeader\022\024\n\014se"
  "rvice_name\030\001 \001(\014\022\026\n\016service_method\030\002 \001(\014"
...
const ::_pbi::DescriptorTable descriptor_table_header_2eproto = {
    false, false, 106, descriptor_table_protodef_header_2eproto,
    "header.proto",
...
RpcHeader::RpcHeader(const RpcHeader& from)
  ...
  new (&_impl_) Impl_{
    ...
    , decltype(_impl_.service_method_){}
  ...
  _impl_.service_method_.InitDefault();
  #ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
    _impl_.service_method_.Set("", GetArenaForAllocation());
  #endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (!from._internal_service_method().empty()) {
    _this->_impl_.service_method_.Set(from._internal_service_method(), 
      _this->GetArenaForAllocation());
  }
...
inline void RpcHeader::SharedDtor() {
  ...
  _impl_.service_method_.Destroy();
}
...
uint8_t* RpcHeader::_InternalSerialize(
  ...
  // bytes service_method = 2;
  if (!this->_internal_service_method().empty()) {
    target = stream->WriteBytesMaybeAliased(
...
void RpcHeader::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg) {
  ...
  if (!from._internal_service_method().empty()) {
    _this->_internal_set_service_method(from._internal_service_method());
  }
...
void RpcHeader::InternalSwap(RpcHeader* other) {
  ...
  ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::InternalSwap(
      &_impl_.service_method_, lhs_arena,
      &other->_impl_.service_method_, rhs_arena
  );
