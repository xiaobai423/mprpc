...
class RpcHeader final :
 ...
 public:
  ...
  // bytes service_method = 2;
  void clear_service_method();
  const std::string& service_method() const;
  template <typename ArgT0 = const std::string&, typename... ArgT>
  void set_service_method(ArgT0&& arg0, ArgT... args);
  std::string* mutable_service_method();
  PROTOBUF_NODISCARD std::string* release_service_method();
  void set_allocated_service_method(std::string* service_method);
  private:
  const std::string& _internal_service_method() const;
  inline PROTOBUF_ALWAYS_INLINE void _internal_set_service_method(const std::string& value);
...
// bytes service_method = 2;
inline void RpcHeader::clear_service_method() {
  _impl_.service_method_.ClearToEmpty();
}
inline const std::string& RpcHeader::service_method() const {
  // @@protoc_insertion_point(field_get:mprpc.RpcHeader.service_method)
  return _internal_service_method();
}
template <typename ArgT0, typename... ArgT>
inline PROTOBUF_ALWAYS_INLINE
void RpcHeader::set_service_method(ArgT0&& arg0, ArgT... args) {
 
 _impl_.service_method_.SetBytes(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:mprpc.RpcHeader.service_method)
}
inline std::string* RpcHeader::mutable_service_method() {
  std::string* _s = _internal_mutable_service_method();
  // @@protoc_insertion_point(field_mutable:mprpc.RpcHeader.service_method)
  return _s;
}
inline const std::string& RpcHeader::_internal_service_method() const {
  return _impl_.service_method_.Get();
}
inline void RpcHeader::_internal_set_service_method(const std::string& value) {
  
  _impl_.service_method_.Set(value, GetArenaForAllocation());
}
inline std::string* RpcHeader::_internal_mutable_service_method() {
  
  return _impl_.service_method_.Mutable(GetArenaForAllocation());
}
inline std::string* RpcHeader::release_service_method() {
  // @@protoc_insertion_point(field_release:mprpc.RpcHeader.service_method)
  return _impl_.service_method_.Release();
}
inline void RpcHeader::set_allocated_service_method(std::string* service_method) {
  if (service_method != nullptr) {
    
  } else {
    
  }
  _impl_.service_method_.SetAllocated(service_method, GetArenaForAllocation());
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (_impl_.service_method_.IsDefault()) {
    _impl_.service_method_.Set("", GetArenaForAllocation());
  }
#endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  // @@protoc_insertion_point(field_set_allocated:mprpc.RpcHeader.service_method)
}
...
inline uint32_t RpcHeader::_internal_arg_size() const {
  return _impl_.arg_size_;
}
inline uint32_t RpcHeader::arg_size() const {
  // @@protoc_insertion_point(field_get:mprpc.RpcHeader.arg_size)
  return _internal_arg_size();
}
inline void RpcHeader::_internal_set_arg_size(uint32_t value) {
  
  _impl_.arg_size_ = value;
}
inline void RpcHeader::set_arg_size(uint32_t value) {
  _internal_set_arg_size(value);
  // @@protoc_insertion_point(field_set:mprpc.RpcHeader.arg_size)
}
